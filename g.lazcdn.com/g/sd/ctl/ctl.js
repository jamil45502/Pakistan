! function i(e, t, n) {
    ...
    1: [function(e, t, n) {
        ...
        function i(e) {
            return this instanceof i ? (this._state = o, this._onFulfilled = [], this._onRejected = [], this._value = null, this._reason = null, l(e) && e(d(this.resolve, this), d(this.reject, this)), void 0) : new i(e)
        }
        ...
        i.prototype = {
            ...
            flush: function() {
                var e = this._state;
                if (e !== o) {
                    var t = e === r ? this._onFulfilled.slice() : this._onRejected.slice(),
                        n = e === r ? this._value : this._reason;
                    setTimeout(function() {
                        m(t, function(e) {
                            try {
                                e(n)
            ...
            resolve: function(e) {
                this._state === o && (this._state = r, this._value = e, this.flush())
            },
            reject: function(e) {
                this._state === o && (this._state = a, this._reason = e, this.flush())
            },
            always: function(e) {
    ...
    4: [function(e, t, n) {
        var o = e("./Promise"),
            ...
            d = s.ctl = {
                ...
                config: function(e, t) {
                    return s.UA_Opt && s.UA_Opt.LogVal ? void 0 : (c = s.UA_Opt = s.UA_Opt || {}, t || (t = e, e = "def"), e = (e + "").toLowerCase(), t = a.extend(c, r.map[e] || r.map.def, t || {}), c.LogVal && (s[c.LogVal] = ""), t)
                },
                getUA: function() {
                    c = s.UA_Opt = s.UA_Opt || {};
                    var e = c.Token;
                ...
                ready: function(e, t) {
                    return g.promise.then(e, t), g.promise
                }
            };
        d.config();
        var l = null,
        ...
        ! function(e, t) {
            ...
            function l(t, o) {
                ...
                for (var f in g_moduleConfig)
                    if (g_moduleConfig.hasOwnProperty(f) && f === t) {
                        ...
                        l.normalAddresses = p ? m.grey.slice() : m.stable.slice(), m.stableBr && m.greyBr && (l.brAddresses = p ? m.greyBr.slice() : m.stableBr.slice()), "etModule" === t && (i ? (l.normalAddresses.pop(), l.brAddresses.pop()) : a ? (l.normalAddresses.pop(), l.brAddresses.pop()) : s || u || c ? (l.normalAddresses.shift(), l.brAddresses.shift()) : d() ? (l.normalAddresses.pop(), l.brAddresses.pop()) : (l.normalAddresses.shift(), l.brAddresses.shift()));
                        for (var h = 0; h < l.normalAddresses.length; h++) {
                            var g = o ? "https://" + o + "/" : A;
                            ("https://assets.alicdn.com/" === g || "https://lzd-g.slatic.net/" === g || "https://g.lazcdn.com/" === g) && (g += "g/"), l.normalAddresses[h] = g + l.normalAddresses[h], l.brAddresses[h] && (l.brAddresses[h] = g + l.brAddresses[h])
                        }
                        return l
                    }
            }
            ...
            function W(e, t, n, o) {
                var r = T(e);
                if (!r) return "function" == typeof t && t(v), void 0;
                var a = n && n.cdn,
                    i = n && n.sync,
                    s = n && n.timeout || 5e3;
                ...
                d.module = r, d.name = e, d.state = m, d.callbacks = d.callbacks || [], d.options = n, t && d.callbacks.push(t), d.timeoutTimer = setTimeout(function() {
                    d.state = h, j(d, n && n.throwExceptionInCallback)
                }, s), o || f.push(d);
                var p = r.sync;
                i && (p = i);
                var g = l(r.name, a);
            ...
            function M(e, t, n) {
                ...
                try {
                    ...
                    for (var a = void 0, i = 0; i < f.length; i++) {
                        var s = f[i];
                        s.module === r && s.name === t && (o = s.options && s.options.throwExceptionInCallback, a = s, clearTimeout(a.timeoutTimer), delete a.timeoutTimer, a.exportObj = n, s.state === m || s.state === h ? (a.state = p, setTimeout(function() {
                            j(a, o)
                        }, 0)) : void 0)
                    }
                    a || (a = {}, a.module = r, a.name = t, a.state = p, a.exportObj = n, a.callbacks = [], f.push(a))
                } catch (u) {
                    if (o) throw u;
    ...
    5: [function(e, t, n) {
        t.exports = {
            extend: function(e) {
                for (var t = [].slice.call(arguments), n = t.length, o, r, a = 1; n > a; a++) {
                    o = t[a];
                    for (r in o) o.hasOwnProperty(r) && ("Flag" === r && e[r] ? e[r] = e[r] | o[r] : e[r] = o[r])
                }
                return e
            }
        }
