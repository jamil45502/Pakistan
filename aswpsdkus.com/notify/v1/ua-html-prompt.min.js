/*! UA-Web-Push: 2e5d60b:1681937253462 */ ! function(n) {
    var t = {};
    ...
    109: function(n, t, e) {
        ...
        var i = e(15),
            a = e(110);
        i.default("html-prompt", (function(n, t) {
            void 0 === n && (n = {});
            return r(this, void 0, void 0, (function() {
                return o(this, (function(e) {
                    return [2, new a.default(n, t)]
                }))
            }))
        }))
    },
    110: function(n, t, e) {
        "use strict";
        var r, o = this && this.__extends || (r = function(n, t) {
            ...
            a = this && this.__awaiter || function(n, t, e, r) {
                return new(e || (e = Promise))((function(o, i) {
                    function a(n) {
                        try {
                            l(r.next(n))
            ...
            l = this && this.__read || function(n, t) {
            ...
            m = function(n) {
                function t(t, e) {
                    ...
                    return r.options = Object.assign({
                        ...
                        stylesheet: null,
                        templates: {}
                    }, t), r.ua = e, r.options.auto ? (r.prompt(), r) : r
                }
                return o(t, n), Object.defineProperty(t.prototype, "templates", {
                    get: function() {
                        return i({
                            alert: c.default,
                            bell: f.default
                    ...
                    enumerable: !1,
                    configurable: !0
                }), t.prototype.prompt = function(n) {
                    var t = this;
                    void 0 === n && (n = {});
                    var e = i(i({}, this.options), {
                        options: n
                    });
                    return this.ua.then((function(n) {
                        if (!(!n.channel || !n.channel.optedIn)) return !1;
                        var r = function() {
                                return a(t, void 0, void 0, (function() {
                                    ...
                                    return s(this, (function(r) {
                                        switch (r.label) {
                                            case 0:
                                                return r.trys.push([0, 2, , 3]), [4, n.register()];
                                            case 1:
                                                return t = r.sent(), this.dispatchEvent({
                                                    type: "register",
                                                    channel: t
                                                }), [2, t];
                                            case 2:
                                                return e = r.sent(), this.dispatchEvent({
                                                    type: "error",
                                                    error: e
                                                }), console.error(e), [2, !1];
                                            case 3:
                            ...
                            o = n.canRegister || n.isSupported && h.default(),
                            i = !g.default() || !n.isRegistrationDomain && !h.default();
                        return o ? "granted" === Notification.permission ? (r(), !1) : (t.addEventListener("accept", r), t._prompt(e)) : !!i && n.plugins.get("registration-page").then((function(n) {
                            return t.addEventListener("accept", (function() {
                                n.open()
                            })), t._prompt(e)
                        })).catch((function(n) {
                ...
                }, t.prototype._prompt = function(n) {
                    var t = this.templates,
                        e = n.type;
                    return e && void 0 !== t[e] ? (this.docReady(this.buildDom.bind(this, document, t[e], n)), !0) : (console.error("Airship Prompt Error: Unknown prompt type '%s'.", e), !1)
                }, t.prototype.createPlaceholder = function() {
                    var n = document.createElement("div");
                    return n.className = "airship-html-prompt-shadow", document.body.appendChild(n), n
                }, t.prototype.createContainer = function(n, t) {
                    var e = document.createElement("div");
                    return e.className = "airship-prompt-container", e.style.display = "none", e.innerHTML = n.template(t), e
                }, t.prototype.createStyle = function(n) {
                    var t = document.createElement("style");
                    return n.style && (t.textContent = n.style.toString()), t
                }, t.prototype.createExternalStylesheet = function(n) {
                    var t = document.createElement("link");
                    return t.setAttribute("rel", "stylesheet"), t.setAttribute("type", "text/css"), t.setAttribute("href", n.stylesheet), t
                }, t.prototype.buildDom = function(n, t, e) {
                    var r = this;
                    if (!p.shouldAsk(e.askAgainDelay, e.type)) return !1;
                    var o = e.placeholder ? n.querySelector(e.placeholder) : this.createPlaceholder();
                    if (!o) return console.error("Airship Prompt Error: placeholder element does not exist in page"), !1;
                    var i = o.attachShadow({
                            mode: "open"
                        }),
                        a = this.createContainer(t, e),
                        s = this.createStyle(t);
                    ...
                    if (e.stylesheet) {
                        var u = this.createExternalStylesheet(e);
                        u.addEventListener("load", (function() {
                            setTimeout(l, e.appearDelay)
                        })), i.appendChild(u)
                    } else setTimeout(l, e.appearDelay);
                    return this.setupListeners(i), p.saveLastAsk(e.type), Number(e.disappearDelay) > 0 && setTimeout((function() {
                        r.dispatchEvent({
                            type: "hide"
                        }), a.style.display = "none"
                    }), e.disappearDelay), !0
                }, t.prototype.setupListeners = function(n) {
                    var t = this,
                        e = function() {
                            t.dispatchEvent({
                                type: "hide"
                            }), n.querySelectorAll("[data-airship-prompt]").forEach((function(n) {
                                n.style.display = "none"
                            }))
                        },
                        r = l([n.querySelector("[data-airship-trigger-accept]"), n.querySelector("[data-airship-trigger-deny]"), n.querySelector("[data-airship-trigger-goto-airship]")], 3),
                        o = r[0],
                        i = r[1],
                        a = r[2];
                ...
                }, t.prototype.docReady = function(n) {
                    document.readyState.match(/complete|interactive/) ? setTimeout(n, 10) : document.addEventListener("DOMContentLoaded", n)
                }, t
            }(d.EventTarget);
        t.default = m
    },
    111: function(n, t, e) {
        ...
        Object.defineProperty(t, "__esModule", {
            value: !0
        }), t.shouldAsk = t.getLastAsk = t.saveLastAsk = void 0;
        var r = "airship_prompt_last_asked_";
        ...
        function i(n) {
            return parseInt(window.localStorage.getItem(r + n) || "0")
        }
        t.saveLastAsk = function(n) {
            window.localStorage.setItem(r + n, o().toString())
        }, t.getLastAsk = i, t.shouldAsk = function(n, t) {
            var e = i(t);
            return !e || o() - e > n
        }
    },
    ...
    15: function(n, t, e) {
        ...
        var r = "Airship Prompt Error: Airship SDK cannot be found.\nThis script should only be loaded through the SDK.";
        t.default = function(n, t) {
            var e = document.getElementById("_uasdk");
            if (!e) throw new Error(r);
            var o = e.getAttribute("rel") || "UA",
                i = window,
                a = e && i[o] ? i[o] : null;
            if (!a) throw new Error(r);
            a.then((function(e) {
                e.plugins._setLoaded(n, t, a)
            }))
        }
    },
    16: function(n, t, e) {
        ...
        n.exports = function(n) {
            ...
            return t.toString = function() {
                ...
                for (var s = 0; s < n.length; s++) {
                    var l = [].concat(n[s]);
                    r && o[l[0]] || (e && (l[2] ? l[2] = "".concat(e, " and ").concat(l[2]) : l[2] = e), t.push(l))
                }
            }, t
        }
    },
    21: function(n, t, e) {
        ...
        var r = e(6);
        t.default = function() {
            var n = window.isSecureContext;
            return void 0 !== n ? n : Boolean(r.default().protocol.match("https"))
        }
    },
    3: function(n, t, e) {
        "use strict";
        ...
        function i(n) {
            const t = r.get(n);
            return console.assert(null != t, "'this' is expected an Event object, but got", n), t
        }

        function a(n) {
            null == n.passiveListener ? n.event.cancelable && (n.canceled = !0, "function" == typeof n.event.preventDefault && n.event.preventDefault()) : "undefined" != typeof console && "function" == typeof console.error && console.error("Unable to preventDefault inside passive event listener invocation.", n.passiveListener)
        }
        ...
        function u(n) {
            if (null == n || n === Object.prototype) return s;
            let t = o.get(n);
            return null == t && (t = function(n, t) {
                ...
                for (let o = 0; o < e.length; ++o) {
                    const i = e[o];
                    if (!(i in n.prototype)) {
                        const n = "function" == typeof Object.getOwnPropertyDescriptor(t, i).value;
                        Object.defineProperty(r.prototype, i, n ? p(i) : l(i))
                    }
                }
                return r
            }(u(Object.getPrototypeOf(n)), n), o.set(n, t)), t
        }

        function c(n) {
            return i(n).immediateStopped
        }

        function f(n, t) {
            i(n).passiveListener = t
        }
        s.prototype = {
            get type() {
            ...
            stopPropagation() {
                const n = i(this);
                n.stopped = !0, "function" == typeof n.event.stopPropagation && n.event.stopPropagation()
            },
            stopImmediatePropagation() {
                const n = i(this);
                n.stopped = !0, n.immediateStopped = !0, "function" == typeof n.event.stopImmediatePropagation && n.event.stopImmediatePropagation()
            },
            get bubbles() {
        ...
        function m(n, t) {
            Object.defineProperty(n, "on" + t, function(n) {
                return {
                    get() {
                        let t = g(this).get(n);
                        for (; null != t;) {
                    ...
                    set(t) {
                        ...
                        let r = null,
                            o = e.get(n);
                        for (; null != o;) 3 === o.listenerType ? null !== r ? r.next = o.next : null !== o.next ? e.set(n, o.next) : e.delete(n) : r = o, o = o.next;
                        if (null !== t) {
                            const o = {
                                listener: t,
                                listenerType: 3,
        ...
        function y(n) {
            ...
            for (let e = 0; e < n.length; ++e) m(t.prototype, n[e]);
            return t
        }
        ...
        b.prototype = {
            addEventListener(n, t, e) {
                ...
                const r = g(this),
                    o = h(e),
                    i = (o ? Boolean(e.capture) : Boolean(e)) ? 1 : 2,
                    a = {
                        listener: t,
                        listenerType: i,
                ...
                let s = r.get(n);
                if (void 0 === s) return void r.set(n, a);
                let l = null;
                for (; null != s;) {
            ...
            removeEventListener(n, t, e) {
                if (null == t) return;
                const r = g(this),
                    o = (h(e) ? Boolean(e.capture) : Boolean(e)) ? 1 : 2;
                let i = null,
                    a = r.get(n);
                for (; null != a;) {
                    if (a.listener === t && a.listenerType === o) return void(null !== i ? i.next = a.next : null !== a.next ? r.set(n, a.next) : r.delete(n));
                    i = a, a = a.next
                }
            },
            dispatchEvent(n) {
                if (null == n || "string" != typeof n.type) throw new TypeError('"event.type" should be a string.');
                const t = g(this),
                    e = n.type;
                let r = t.get(e);
                if (null == r) return !0;
                const o = function(n, t) {
                    return new(u(Object.getPrototypeOf(t)))(n, t)
                }(this, n);
                let a = null;
                for (; null != r;) {
                    if (r.once ? null !== a ? a.next = r.next : null !== r.next ? t.set(e, r.next) : t.delete(e) : a = r, f(o, r.passive ? r.listener : null), "function" == typeof r.listener) try {
            ...
            configurable: !0,
            writable: !0
        }), "undefined" != typeof window && void 0 !== window.EventTarget && Object.setPrototypeOf(b.prototype, window.EventTarget.prototype), t.defineEventAttribute = m, t.EventTarget = b, t.default = b, n.exports = b, n.exports.EventTarget = n.exports.default = b, n.exports.defineEventAttribute = m
    },
    35: function(n, t, e) {
        "use strict";
        Object.defineProperty(t, "__esModule", {
                value: !0
            }), t.BellPositions = t.AlertPositions = void 0,
            function(n) {
                n.TOP = "top", n.BOTTOM = "bottom"
            }(t.AlertPositions || (t.AlertPositions = {})),
            function(n) {
                n.TOP_LEFT = "top-left", n.TOP_RIGHT = "top-right", n.BOTTOM_LEFT = "bottom-left", n.BOTTOM_RIGHT = "bottom-right"
            }(t.BellPositions || (t.BellPositions = {}))
    },
    4: function(n, t, e) {
        "use strict";
        var r = this && this.__read || function(n, t) {
            var e = "function" == typeof Symbol && n[Symbol.iterator];
            if (!e) return n;
            var r, o, i = e.call(n),
                a = [];
        ...
        Object.defineProperty(t, "__esModule", {
            value: !0
        }), t.getIntlDetails = t.getTranslation = void 0, t.getTranslation = function(n, t) {
            var e = Object.keys(n).reduce((function(t, e) {
                    return t[e.toLowerCase()] = n[e], t
                }), {}),
                r = Object.keys(e),
                o = window.navigator.languages.map((function(n) {
            ...
            var a = r.find((function(n) {
                return o.includes(n.substr(0, 2))
            }));
            return a ? e[a] : e[t.toLowerCase()] || e.en
        }, t.getIntlDetails = function(n) {
            var t = Intl.DateTimeFormat().resolvedOptions(),
                e = t.timeZone,
                o = r(t.locale.split("-"), 2),
                i = o[0],
                a = o[1],
                s = (null == n ? void 0 : n.language) || i,
                l = (null == n ? void 0 : n.country) || a;
            return !l && navigator.languages && (l = navigator.languages.reduce((function(n, t) {
                return n || (n = t.includes("-") ? t.split("-")[1] : null), n
            }), null) || ""), {
                localeCountry: l,
                localeLanguage: s,
                timezone: e
    ...
    7: function(n, t, e) {
        ...
        Object.defineProperty(t, "__esModule", {
            ...
            return void 0 === n && (n = self), !("PushManager" in n) && !!("safari" in n || navigator.userAgent.match(/Safari/) && !navigator.userAgent.match(/Chrome/))
        }
    }
});